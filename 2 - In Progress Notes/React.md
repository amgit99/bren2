...
<span style="color:#e1db3d">Event Listeners</span>: more about this in [[JavaScript - YT talk]]. To handle them, functions are passed to the on{change/keydown...} prop of the component/html tag and functions that take an event object as a parameter handles the event.
